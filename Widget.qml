...
Panel {
  id: root
  moduleName: "modib.activity-monitor"
  ipcTarget: "modib.activity-monitor"
  manageIpc: false
  ...
  readonly property var cells: {
    ...
    if (root.showFan && hw.fanRpm >= 0 && showTemps && mode === "icons") {
      cellMap["fan"] = {
        ...
        label: "FAN",
        icon: fanIcon,
        iconRotation: fanIconRotation,
        value: Model.formatRpm(hw.fanRpm),
        pad: "",
        slotted: false,
        temp: "",
        tempC: -1,
  ...
  readonly property string hint: clickCommand === ""
    ? "Activity Monitor · right click for " + nextMode
